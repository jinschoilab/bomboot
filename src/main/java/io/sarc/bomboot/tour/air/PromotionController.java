...
public class PromotionController {
	...
	private String api = "/v1/tour/air/promotion";

	@ApiOperation(value = "promotion", notes = "Promotion")
	@RequestMapping(value = "/v1/tour/air/promotion/{category}")
	public String promotion(@PathVariable("category") String category) {
		...
		apiLog.add(api, category+"_"+count);
